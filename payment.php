    ...
    <h3>Invoice Payments</h3>
        ...
        <form method="POST" action="" id="paymentform"  >
                        <select id="invoicenumber" name="invoicenumber" class="form-control js-example-basic-single" required>
                            ...
                            <?php
                            $result2 = mysqli_query($conn,"SELECT invoicenumber, house_code, billdate FROM  `invoices` order by invoicenumber desc");
...
<input type="text" id="pay" name="pay" placeholder="Pay Here" class="form-control" pattern="[0-9]+(\.[0-9]{1,2})?" title="Enter a valid number with up to two decimal places">
