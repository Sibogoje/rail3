...
<nav role="navigation" class="header-nav" >
  ...
  right: 0px;">
        ...
        <div class="menu">
            ...
            <li><a href="payments.php" class="list-group-item"><i class="fa fa-money"></i> Process Invoice</a> </li>

            <li><a href="https://liquag.com/dev/rail3/payments/logout.php" class="list-group-item"><i class="fa fa-power-off"></i> Log Out</a> </li>
            </ul>
         </div>
        </div>
    </div>
