            ...
            <tbody>
			 ...
			 <tr>
                ...
                <tr>
                    ...
                    <td style="width: 40%;font-size: 18px; border-top: 0px;  border-left: 0px; border-bottom: 0px;"><?php echo $phone; ?></td>
                ...
                <tr>
                    ...
                    <td style="width: 40%;font-size: 18px; border-top: 0px;  border-left: 0px; border-bottom: 0px;"><?php echo $email; ?></td>
                ...
                <tr>
                    ...
                    <td style="width: 40%;font-size: 18px; border-left: 0px; border-top: 0px;"><?php echo $address; ?></td>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="width: 9.5%;font-size: 18px; font-weight: bold;"></td>
                </tr>
                <tr>
                    <td style="width: 5.28%;: 0px;font-size: 18px; border: 0px;"></td>
                    <td style="width: 5.28%;: 0px;font-size: 18px; border: 0px;"></td>
                ...
                <tr>
                    ...
                    <td style="width: 9.5%;: 3px;font-size: 18px;">180</td>
                ...
                <tr>
                    ...
                    <td style="width: 9.5%;font-size: 18px;">E <?php echo $w; ?></td>
                </tr>
                <tr>
                ...
                <tr style="margin-bottom: -18px;">
                    ...
                    <td style="width: 9.5%;font-size: 18px; font-weight: bold;">E <?php echo $w; ?></td>
                </tr>
				<tr style="margin-bottom: -18px;">
