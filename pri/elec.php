        ...
        <table class="table">
            ...
            <tbody>
			 ...
			 <tr>
                ...
                <?php 
$result1 = mysqli_query($conn,"SELECT * FROM `invoices`  $clientquery $inyanga $sterr AND e_units != 0.00  AND `year` = '$yrs' ORDER BY `tenant`");
