...
if (!empty($_POST["prints"])) {
	...
	$yrs=$_POST['yearrepo'];
    $houses=$_POST['houserepo'];

	
if (!empty($clients)) {
    
    if ($clients == 'all'){
        $clientquery = "house_code != '011' "; 
    }else{
        $clientquery = "tenant = '$clients' ";
    }
} else if (!empty($houses)) {
    if ($houses == 'all'){
        $clientquery = "house_code != '011' "; 
    }else{
        $clientquery = "house_code = '$houses' ";
    }
}
...
$mntharray2 =  str_replace( array('[',']') , ''  , $mntharray1 );
   ...
   // $clientquery = "WHERE tenant = '$clients' ";
    //$housequery = "AND house_code = '$houses' ";
        ...
        <table class="table" style="font-size: 20px;">
            ...
            <tbody>
			 <tr>
                    ...
                    <td colspan="9" style="border-left: 0px; border-right: 0px; border-top: 0px; margin-top: 1px;">
			 ...
			 <tr style="font-size: 20px;">
                ...
                <?php 
$result1 = mysqli_query($conn,"SELECT * FROM `invoices` WHERE   $clientquery $inyanga $sterr AND `year` = '$yrs' ORDER BY `tenant`");
...
?>
                ...
                <tr>
                    ...
                    <td style="border: 1;"><?php echo  $electricity_charge; ?></td>
                    <?php $tt1 = $water_charge + $sewage_charge2 + $electricity_charge; ?>
                ...
                <tr>
                    ...
                    <td style="border: 1; font-weight: bold; text-align: right;" colspan="8">Grand Total</td>
