...
<nav role="navigation" class="header-nav" >
  ...
  right: 0px;">
        <img class="img-responsive" src="https://grinpath.com/rail/images/logo1.png" style="display:flex; justify-content: left; margin-top:2px; width:180px;  ">
        ...
        <div class="menu">
            ...
            <li><a href="https://grinpath.com/rail/tenants.php" class="list-group-item"><i class="fa fa-list"></i>  All tenants</a> </li>

            <li><a href="https://grinpath.com/rail/houses2.php" class="list-group-item"><i class="fa fa-home"></i> Houses Data</a> </li>
             <li><a href="https://grinpath.com/rail/faults.php" class="list-group-item"><i class="fa fa-money"></i> Report Faults</a> </li>
            <li><a href="https://grinpath.com/rail/house_profile.php" class="list-group-item"><i class="fa fa-money"></i> House Profile</a> </li>

            <li><a href="https://grinpath.com/rail/billing.php" class="list-group-item"><i class="fa fa-file"></i> Billing</a> </li>
            ...
            <li><a href="https://grinpath.com/rail/script/logout.php" class="list-group-item"><i class="fa fa-power-off"></i> Log Out</a> </li>
            </ul>
         </div>
        </div>
    </div>
