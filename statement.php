...
<div class="container custom-container text-center" style="margin-top: 30px;">
    ...
    <h3>House Statement</h3>
        <form method="POST" action="printstatement.php" target="_blank" id="paymentform"  >
                        <select id="invoicenumber" name="house" class="form-control js-example-basic-single" required>
